...
class GeoHash
{
     ...
     * @return string
     */
    public static function encode($lng, $lat, $prec = self::PRECISION_HIGH_CM_3_X_1)
    {
        $minlng = -180;
        $maxlng = 180;
        $minlat = -90;
